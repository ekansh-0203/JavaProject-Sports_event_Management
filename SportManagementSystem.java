...
public class SportManagementSystem extends JFrame {
    ...
    private JButton addPlayerBtn, createTeamBtn, registerEventBtn, viewDetailsBtn, exitBtn;
    private JTextArea displayArea;
    private final Color primary = new Color(30, 144, 255); // DodgerBlue
    ...
    private void createTeam() {
        ...
        JComboBox<String> sportCombo = new JComboBox<>(new String[]{
                "Cricket", "Basketball", "Football", "Volleyball"
        });
        ...
        Object[] fields = {
                ...
                "Sport:", sportCombo,
                "Members (comma separated):", membersField
        };
    ...
    private void registerEvent() {
        ...
        Object[] fields = {
                ...
                "Teams (comma separated):", teamField
        };
    ...
    private void viewDetails() {
        ...
        sb.append(" === PLAYERS ===\n");
        sb.append(readFile("players.txt"));
        sb.append("\n === TEAMS BY SPORT ===\n");
        sb.append(groupTeamsBySport());
        sb.append("\n === EVENTS ===\n");
        sb.append(readFile("events.txt"));
